...
export const FavoriteRecipesModal: React.FC<FavoriteRecipesModalProps> = ({
  ...
  return (
    <Modal isOpen={true} onClose={onClose}>
      <div className="bg-orange-50 rounded-lg shadow-xl w-full max-w-4xl mx-auto max-h-[90vh] flex flex-col">
        <div className="p-5 border-b border-orange-200 flex justify-between items-center sticky top-0 bg-orange-50 z-10">
          <div className="flex items-center">
            <StarIcon className="w-8 h-8 text-yellow-400 mr-3" />
            <h2 className="text-2xl font-bold text-orange-600">お気に入りレシピ ({favorites.length})</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-t border-orange-200 text-center sticky bottom-0 bg-orange-50 z-10">
          <button
            onClick={onClose}
